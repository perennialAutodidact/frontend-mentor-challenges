...
declare module "nextjs-routes" {
  export type Route =
    | { pathname: "/challenges/[[...challengeLevel]]"; query?: Query | undefined }
    | { pathname: "/challenges/junior/cc-form"; query?: Query | undefined }
    | { pathname: "/challenges/junior/intro-section-with-dropdown-nav"; query?: Query | undefined }
